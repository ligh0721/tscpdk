...
inline CSocket* CIoContext::GetIo()
{
    return m_pIo;
}

inline void CIoContext::SetIo(CSocket* pIo)
{
    m_pIo = pIo;
}
...
inline int CEpoll::GetHandle() const
{
    return m_iFd;
}
...
inline CNetEventDriver::CNetEventDriver()
{
...
inline bool CNetEventDriver::RegisterTimer(CTimerNodeBase* pTimer, const CTime& rInterval, const CTime& rDelay)
{
    return m_oTm.AddTimer(pTimer, rInterval, rDelay);
}

inline bool CNetEventDriver::UnregisterTimer(CTimerNodeBase* pTimer)
{
