...
class TSCPDK_API CBlockQueue : public CQueue
{
protected:
...
class TSCPDK_API CWorker : public CThread
{
...
class TSCPDK_API CMirrorWorker : public CWorker
{
public:
