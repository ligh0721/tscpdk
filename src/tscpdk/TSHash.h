...
class TSCPDK_API CSeqHashNode : public CDataSequenceInterface, public CHashNodeBase<KEY, MAPPED>
{
public:
    KEY tKey;
    MAPPED tMapped;
...
public:
    virtual bool Init(uint32_t dwHashWidth, uint32_t dwHashHeight, const KEY& rEmptyKey, const char* pShmName);
    virtual bool Attach(const char* pShmName);
...
class TSCPDK_API CDataSequenceInterface
{
public:
...
public:
    ...
    virtual bool NodeMatch(const KEY& rKey, CHashNode_& rNode);
    virtual bool NodeMatch(const KEY& rKey, CHashNode& rNode);
...
public:
    virtual bool Init(uint32_t dwHashWidth, uint32_t dwHashHeight, const KEY& rEmptyKey, const char* pShmName, const char* pBinlogPrefix, const char* pBinlogSuffix, const char* pDumpPrefix, const char* pDumpSuffix);
    virtual bool Attach(const char* pShmName, const char* pBinlogPrefix, const char* pBinlogSuffix, const char* pDumpPrefix, const char* pDumpSuffix);
