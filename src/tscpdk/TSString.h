...
class TSCPDK_API CStr : public CMemoryStream
{
public:
    CStr(size_t uSize);
...
{
public:
    static const char* PickOutWord(const char* pStr, char cLeftPair, char cRightPair, const char* pLeftSeps, const char* pRightSeps, char* pSep, size_t* pWordLen);
...
public:
    ...
    virtual const char* GetNextStringPos(size_t& uLen);
