...
public:
    ...
    // 返回actionTag
    virtual int doAnimation(int id, CCallFuncData* pOnNotifyFrame, int iRepeatTimes, CCallFuncData* pOnAnimationDone, float fSpeed = 1.0f);
...
public:
    ...
    M_SYNTHESIZE(CPoint, m_oPosition, Position);
